...
<main class="discord_bg_2">
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-body-tertiary index text-white">
        <div class="col-md-6 p-lg-5 mx-auto my-5">
            <h1 class="display-3 fw-bold fadeIn fadeAnimationDown">An app for people</h1>
            <h3 class="fw-normal text-white mb-3 fadeIn fadeAnimationDown">An integrated system application based on the Discord platform</h3>
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                ...
                <button type="button" class="btn btn-secondary btn-lg px-4" onclick="window.location.href='https://discord.com/invite/vTU4dGrA?utm_source=Discord%20Widget&utm_medium=Connect'" >Developer's Server</button>
            </div>
        </div>
    ...
    <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
        <div class="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden w-100 fadeIn fadeAnimationUp">
            <div class="my-3 py-3">
                <h2 class="display-5">Custom Commands</h2>
                <p class="lead">With many hidden moderation actions. Don't be afraid.</p>
            </div>
            <img src="/assets/images/simplex_product_img1.png" class="p-3" width="300" height="300" alt="">
        </div>
        <div class="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden w-100 fadeIn fadeAnimationUp">
            <div class="my-3 p-3">
                <h2 class="display-5">Message audit</h2>
                <p class="lead">If desired, we store user messages in the database for our administrators and moderators.</p>
            </div>
            <div>
                <h1>
                    We have already saved <mark class="badge bg-primary">
                        <?php
                            if ($table_messages) echo $table_messages->num_rows;
                            else echo "MANY";
                        ?>
                    </mark> messages in the database.
                </h1>
            </div>
        </div>
    </div>
